 ...
 ** File	:	P:/XIANYU/projects/AnLu/Ethernet/project_temac_lana/al_ip/data_fifo.v
 ** Date	:	2023 11 06
...
module data_fifo #(parameter DATA_WIDTH_W = 32, 
        parameter DATA_WIDTH_R = 8, 
        parameter ADDR_WIDTH_W = 9, 
        parameter ADDR_WIDTH_R = 11, 
        parameter AL_FULL_NUM = 360, 
        parameter AL_EMPTY_NUM = 20, 
    ...
    fifo_cross_domain_addr_process_al_data_fifo #(.ADDR_WIDTH(ADDR_WIDTH_R)) rd_to_wr_cross_inst (.primary_asreset_i(rd_rst), 
    ...
    fifo_cross_domain_addr_process_al_data_fifo #(.ADDR_WIDTH(ADDR_WIDTH_W)) wr_to_rd_cross_inst (.primary_asreset_i(wr_rst), 
                .secondary_asreset_i(rd_rst), 
                .primary_clk_i(clkw), 
                .secondary_clk_i(clkr), 
                .primary_addr_i(wr_addr), 
                .secondary_addr_o(wr_to_rd_addr)) ; 
    ram_infer_data_fifo #(.DATAWIDTH_A(DATA_WIDTH_W),
...
// ===========================================================================
module fifo_cross_domain_addr_process_al_data_fifo #(parameter ADDR_WIDTH = 9) (
...
// ===========================================================================
module ram_infer_data_fifo (clka, 
        rsta, 
        cea, 
        ocea, 
        wea, 
